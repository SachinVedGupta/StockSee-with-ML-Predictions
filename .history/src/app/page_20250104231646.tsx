      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginTop: "20px" }}>
        ...
        <div style={{ textAlign: "center", border: "1px solid black", padding: "10px" }}>
          <Image
            ...
            height={500}
          />
          <p>Accuracy for the sentiment analysis NLP ML model. Since the model is not retrained/changing/updating unless the speific function is called, this will remain the same</p>
        </div>
