...
export default function Home() {
  ...
  async function handleSubmit() {
    ...
    // Find the index where 'Seperate-Dates' occurs
    ...
    // Set the colors for the lines: blue for the first part, orange for the second
    const pointBackgroundColor = combinedDates.map((date, index) => {
      return index < separateDateIndex
        ? 'rgba(59, 130, 246, 0.6)'  // Blue before 'Seperate-Dates'
        : 'orange';  // Orange after 'Seperate-Dates'
    });
