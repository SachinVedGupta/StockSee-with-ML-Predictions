...
export default function Home() {
  ...
  <>
    ...
    <div style={{ marginBottom: "0px", textAlign: "center" }}>
      ...
      <p style={{ width: "80%", margin: "20px auto", marginBottom: "10px"}}>
        Note: The loss/accuracy cruves below will stay constant in repeated entries since the pre-trained (on the 30 DOW JONES stocks) model is being loaded in. By going in LOCAL, one can then further train the prediction model and/or sentiment analysis ML models. It can also be set so that every new stock ticker entry further trains and improves the prediction model, though this is not possible in the deployed version due to RAM constraints.
      </p>
    </div>
