...
export default function Home() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // Find the index of 'Seperate-Dates'
      const separateDateIndex = dates.indexOf('Seperate-Dates');

      // Everything before the element just before 'Seperate-Dates' goes to the first part
      const firstPartDates = dates.slice(0, separateDateIndex - 1);
      const firstPartPrices = prices.slice(0, separateDateIndex - 1);

      // Everything from the element before 'Seperate-Dates' (including it) goes to the second part
      const secondPartDates = dates.slice(separateDateIndex - 1);
