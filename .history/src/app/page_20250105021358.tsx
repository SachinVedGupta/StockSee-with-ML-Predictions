...
export default function Home() {
  ...
  <>
    ...
    <div style={{ marginBottom: "20px", textAlign: "center" }}>
      <p style={{ width: "100%", margin: "0 auto", marginBottom: "35px",fontSize: "16px" }}>
        <a href="https://github.com/your-repository-link" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "#007bff" }}>
          View on GitHub
        </a>
      </p>
    </div>
