  ...
  <>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginTop: "20px" }}>
      ...
      <div style={{
        ...
        <p style={{ marginTop: "10px", width: "500px", marginLeft: "auto", marginRight: "auto" }}>
          Represents the loss graph for the ML model trained on the stock data (). It will be unique across various trials due to the randomness nature of an LSTM ML model.
        </p>
      </div>
