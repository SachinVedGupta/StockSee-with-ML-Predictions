    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginTop: "20px" }}>
      ...
      <div style={{
        ...
        <p style={{ marginTop: "10px", width: "500px", marginLeft: "auto", marginRight: "auto" }}>
          Each stock prediction consists of 50 days and is based on the previous 200-day time window as an input to the model. The graph shows the past 1500 daily prices for the entered stock. Note, the main StockSee graph above features just the recent 700 days (Time = 800-1500). Can compare the prediction line (in red) with the actual price graph for a general idea of the model's accuracy.
        </p>
      </div>
