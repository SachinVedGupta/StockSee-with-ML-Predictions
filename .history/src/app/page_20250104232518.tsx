      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginTop: "20px" }}>
        <div style={{ textAlign: "center", border: "1px solid black", padding: "10px" }}>
          <Image
            ...
            height={500}
          />
          <p>Each stock prediction consists of 50 days and is based on the previous 200 day time window. Can compare with actual price graph for a general idea of the models accuracy</p>
        </div>
        <div style={{ textAlign: "center", border: "1px solid black", padding: "10px" }}>
          <Image
            src={"/loss_graph.png"}
            ...
            height={500}
          />
          <p>Represents the loss graph for the ML model trained on the stock data of the entered company ticker. It will be unique across various trials due to the randomness nature of an LSTM ML model</p>
        </div>
        <div style={{ textAlign: "center", border: "0px solid black", padding: "10px" }}>
          <Image
            ...
            height={500}
          />
          <p>Accuracy graph for the sentiment analysis NLP ML model. Since the model is not retrained/changing/updating unless the specific retraining function is called, this will generally remain the same as the saved model is just loaded in/used</p>
        </div>
        <div style={{ textAlign: "center", border: "0px solid black", padding: "10px" }}>
          <Image
            ...
            height={500}
          />
          <p>Loss (MSE - Mean Squared Error) graph for the sentiment analysis NLP ML model. Since the model is not retrained/changing/updating unless the specific retraining function is called, this will generally remain the same as the saved model is just loaded in/used</p>
        </div>
      </div>
    </>
  )}
