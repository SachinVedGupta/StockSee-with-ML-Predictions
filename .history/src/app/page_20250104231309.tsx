      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginTop: "20px" }}>
        ...
        <div style={{ textAlign: "center", border: "1px solid black", padding: "10px" }}>
          <Image
            ...
            height={500}
          />
          <p>Represents the loss graph for the ML model trained on the stock data of the entered company ticker. It will be unique across various trials due to the </p>
        </div>
        <div style={{ textAlign: "center", border: "1px solid black", padding: "10px" }}>
          <Image
