...
export default function Home() {
  ...
  <>
    ...
    <div style={{ marginBottom: "0px", textAlign: "center" }}>
      ...
      <p style={{ width: "80%", margin: "20px auto", marginBottom: "10px"}}>
        Note: Predictions will stay constant in repeated entry of the same company ticker since the pre-trained (on the 30 DOW JONES stocks) model is being loaded in and due t
      </p>
    </div>
