...
export default function Home() {
  ...
  <>
    ...
    {/* 2x2 Grid for Images */}
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0px", marginTop: "20px" }}>
      ...
      <div style={{
        ...
        <p style={{ marginTop: "10px", width: "500px", marginLeft: "auto", marginRight: "auto" }}>
          Each stock prediction consists of 50 days and is based on the previous 200-day time window. Can compare with actual price graph for a general idea of the model's accuracy.
        </p>
      </div>
