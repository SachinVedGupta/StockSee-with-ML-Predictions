...
export default function Home() {
    ...
    try {
      ...
      setChartDisplayData({
        ...
        datasets: [
          ...
          {
            label: "Predictions",
            data: combinedPrices,  // Or adjust with prediction data
          ...
          {
            label: "Large Rise Coming",
            data: combinedPrices,  // Modify with your data representing a large rise
          ...
          {
            label: "Large Fall Coming",
            data: combinedPrices,  // Modify with your data representing a large fall
  ...
  <>
    {/* Line Chart */}
    <Line data={chartDisplayData} options={chartDisplayData.options} style={{ marginBottom: "40px" }} />

    {/* Title for About Section */}
    <h4 id="title" style={{ textAlign: "center", fontSize: "2.5rem", marginBottom: "35px", marginTop: "45px" }}>
    ...
    <div style={{ marginBottom: "0px", textAlign: "center" }}>
      <p style={{ width: "80%", margin: "0 auto" }}>
        The yellow dots on the graph above represent predictions for the next 50 days of stock prices, made using a TensorFlow LSTM machine learning model. Each prediction is based on a batch of 200 previous daily stock prices, and the model forecasts the prices for the upcoming 50 days. A total of 1500 days of historical data is utilized in the training and validation process.
      </p>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginTop: "20px" }}>
      ...
      <div style={{
        ...
        <p style={{ marginTop: "10px", width: "500px", marginLeft: "auto", marginRight: "auto" }}>
          Each stock prediction consists of 50 days and is based on the previous 200-day time window. The graphs shows the past 1500 days, which is the data used by the ML model. Can compare with actual price graph for a general idea of the model's accuracy.
        </p>
      </div>
