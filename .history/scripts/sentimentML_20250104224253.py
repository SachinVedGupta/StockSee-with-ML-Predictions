...
def create_save_sentiment_model(): # trains the sentiment analysis ML model and saves it for later use
  ...
  def lr_scheduler(epoch, lr):
      if epoch < 120 and epoch > 15 and epoch % 10 == 0:  # Reduce learning rate after 100 epochs
          return lr * 0.5
      return lr
  ...
  history = model.fit(training_padded, training_labels, epochs=300,  batch_size=16, validation_data=(testing_padded, testing_labels), verbose=2, callbacks=[scheduler])
