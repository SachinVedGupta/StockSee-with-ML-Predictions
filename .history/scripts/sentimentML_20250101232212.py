...
def sentiment_from_sentence(sentence): # uses the already saved model to get the sentiment score for an input sentence
  sentences = [sentence]
...
# print("\n\n\n\n\n\nUSING LOADED MODEL\n\n\n\n\n")
# sentiment_from_sentences("the company had sales increase by 10%")
