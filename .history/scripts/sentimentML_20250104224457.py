...
def create_save_sentiment_model(): # trains the sentiment analysis ML model and saves it for later use
  ...
  history = model.fit(training_padded, training_labels, epochs=150,  batch_size=16, validation_data=(testing_padded, testing_labels), verbose=2, callbacks=[scheduler])
