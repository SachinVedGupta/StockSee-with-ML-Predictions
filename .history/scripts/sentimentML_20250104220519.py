...
def create_save_sentiment_model(): # trains the sentiment analysis ML model and saves it for later use
  ...
  model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dropout(0.5),  # dropout and regularizer to prevent overfitting and too high weights
  ...
  history = model.fit(training_padded, training_labels, epochs=400,  batch_size=32, validation_data=(testing_padded, testing_labels), verbose=2)
