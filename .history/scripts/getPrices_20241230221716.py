...
def historical_prices():
    ...
    return jsonify([dates + the_ml_predictions[0], prices + the]) # dates = list where each item is a date    AND    # prices = list where each item is corresponding stock price
